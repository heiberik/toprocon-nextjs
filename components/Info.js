    ...
    if (showInfo) return (
        <div className="container-info" >
            ...
            <div className="info-text">
                ...
                <p style={{ marginLeft: "30px" }}> <strong className="info-rule"> 1: </strong>
                    Check if a similar topic exists already.
                    </p>
                <p style={{ marginLeft: "30px" }}> <strong className="info-rule"> 2: </strong>
                    Make sure the topic name and description is objective and unbiased.
                    </p>
                <p style={{ marginLeft: "30px" }}> <strong className="info-rule"> 3: </strong>
                ...
                <p style={{ marginLeft: "30px" }}> <strong className="info-rule"> 4: </strong>
            ...
            <button className="info-button" onClick={() => setShowInfo(false)}> I understand! </button>
        </div>
    )
    else return (
        <button className="info-button-white" onClick={() => setShowInfo(true)} style={{marginTop: "20px"}}> Read rules </button>
    )
}
